...
namespace Figurelib
{
    //Целью библиотеки является универсальное опознание фигуры и нахождение ее площади (программа ограничена нахождением
    // площади круга по радиусу и типа с площадью треугольника) 
    public class Square
    {
